...
<body>
  ...
  <!-- Links -->
	...
	<div class="background">
		<i class="fa fa-quote-left"></i><p>Education helps us get exposure to new ideas and concepts that we can use to appreciate and improve the world around us and the world within us.👨‍🎓.</p>
	</div>
	<div class="background">
		<h2>About Us</h2>
		<p>I WELCOME YOU TO MY WEBSITE WHERE I'M DISPLAYING YOU A WEB PAGE THAT PREDICTS YOUR COLLEGE ON THE BASIS OF PREVIOUS PERFORMANCE!!❤✔</p>
		...
		<p>This web page is Designed and Developed by Harshit Agrawal</p>
	</div>
